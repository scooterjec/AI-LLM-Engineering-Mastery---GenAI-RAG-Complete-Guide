...
if __name__ == "__main__":
    ...
    for cfg in config.values():
        ...
        cfg["train_data"].set_format(type="torch")
        cfg["test_data"].set_format(type="torch")
    ...
    training_arguments = TrainingArguments(
        ...
        metrics_for_best_model="accuracy",
    ...
    def predict_text(text, model_path, num_labels, task_type):
        ...
        inputs = tokenizer(text.lower().strip(), return_tensors="pt", truncation=True, max_length=128)
